...
class SampleAverageApproximation(SampleGenerator):
    ...
    """
    def __init__(self, microgrid, control_duration=31536000, **forecast_args):
        if control_duration > 31536000:
...
if __name__ == '__main__':
    ...
    m_gen = MicrogridGenerator.MicrogridGenerator(nb_microgrid=2)
