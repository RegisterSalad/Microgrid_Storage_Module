...
class grid_design():
    ...
    def get_mg_export(self, df_pv, df_genset, df_flywheel, df_vanadiumflow): # Function returns dataframe the total ammount of kWh that the grid can export every timestep
    ...
    def get_cost_per_kwh(self, local_power_cost):  # Retuns dataframe will power cost per kWh when connected to this micro-grid
